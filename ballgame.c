...
Line level1[] = {
    {{0, 80}, {180, 80}},    {{0, 81}, {180, 81}},    {{0, 82}, {180, 82}},    {{0, 83}, {180, 83}},
    {{0, 84}, {180, 84}},    {{0, 85}, {180, 85}},    {{0, 86}, {180, 86}},    {{0, 87}, {180, 87}},

    {{319, 180}, {90, 180}}, {{319, 181}, {90, 181}}, {{319, 182}, {90, 182}}, {{319, 183}, {90, 183}},
    {{319, 184}, {90, 184}}, {{319, 185}, {90, 185}}, {{319, 186}, {90, 186}}, {{319, 187}, {90, 187}},
...
Line level2[] = {
    {{55, 120}, {180, 40}},   {{55, 121}, {180, 41}},   {{55, 122}, {180, 42}},   {{55, 123}, {180, 43}},
    {{55, 124}, {180, 44}},   {{55, 125}, {180, 45}},   {{55, 126}, {180, 46}},   {{55, 127}, {180, 47}},

    {{0, 110}, {40, 110}},    {{0, 111}, {40, 111}},    {{0, 112}, {40, 112}},    {{0, 113}, {40, 113}},
    {{0, 114}, {40, 114}},    {{0, 115}, {40, 115}},    {{0, 116}, {40, 116}},    {{0, 117}, {40, 117}},

    {{0, 170}, {80, 170}},    {{0, 171}, {80, 171}},    {{0, 172}, {80, 172}},    {{0, 173}, {80, 173}},
    {{0, 174}, {80, 174}},    {{0, 175}, {80, 175}},    {{0, 176}, {80, 176}},    {{0, 177}, {80, 177}},

    {{160, 170}, {168, 170}}, {{160, 171}, {168, 171}}, {{160, 172}, {168, 172}}, {{160, 173}, {168, 173}},
    {{160, 174}, {168, 174}}, {{160, 175}, {168, 175}}, {{160, 176}, {168, 176}}, {{160, 177}, {168, 177}},

    {{180, 170}, {188, 170}}, {{180, 171}, {188, 171}}, {{180, 172}, {188, 172}}, {{180, 173}, {188, 173}},
    {{180, 174}, {188, 174}}, {{180, 175}, {188, 175}}, {{180, 176}, {188, 176}}, {{180, 177}, {188, 177}},

    {{170, 210}, {178, 210}}, {{170, 211}, {178, 211}}, {{170, 212}, {178, 212}}, {{170, 213}, {178, 213}},
    {{170, 214}, {178, 214}}, {{170, 215}, {178, 215}}, {{170, 216}, {178, 216}}, {{170, 217}, {178, 217}},
};

Line level3[] = {
    {{40, 10}, {40, 170}},    {{41, 10}, {41, 170}},    {{42, 10}, {42, 170}},    {{43, 10}, {43, 170}},
    {{44, 10}, {44, 170}},    {{45, 10}, {45, 170}},    {{46, 10}, {46, 170}},    {{47, 10}, {47, 170}},

    {{80, 10}, {80, 170}},    {{81, 10}, {81, 170}},    {{82, 10}, {82, 170}},    {{83, 10}, {83, 170}},
    {{84, 10}, {84, 170}},    {{85, 10}, {85, 170}},    {{86, 10}, {86, 170}},    {{87, 10}, {87, 170}},

    {{80, 210}, {40, 170}},   {{81, 210}, {41, 170}},   {{82, 210}, {42, 170}},   {{83, 210}, {43, 170}},
    {{84, 210}, {44, 170}},   {{85, 210}, {45, 170}},   {{86, 210}, {46, 170}},   {{87, 210}, {47, 170}},

    {{80, 210}, {120, 170}},  {{81, 210}, {121, 170}},  {{82, 210}, {122, 170}},  {{83, 210}, {123, 170}},
    {{84, 210}, {124, 170}},  {{85, 210}, {125, 170}},  {{86, 210}, {126, 170}},  {{87, 210}, {127, 170}},

    {{200, 100}, {140, 170}}, {{201, 100}, {141, 170}}, {{202, 100}, {142, 170}}, {{203, 100}, {143, 170}},
    {{204, 100}, {144, 170}}, {{205, 100}, {145, 170}}, {{206, 100}, {146, 170}}, {{207, 100}, {147, 170}},

    {{250, 100}, {310, 170}}, {{251, 100}, {311, 170}}, {{252, 100}, {312, 170}}, {{253, 100}, {313, 170}},
    {{254, 100}, {314, 170}}, {{255, 100}, {315, 170}}, {{256, 100}, {316, 170}}, {{257, 100}, {317, 170}},

    {{140, 170}, {317, 170}}, {{140, 171}, {317, 171}}, {{140, 172}, {317, 172}}, {{140, 173}, {317, 173}},
    {{140, 174}, {317, 174}}, {{140, 175}, {317, 175}}, {{140, 176}, {317, 176}}, {{140, 177}, {317, 177}},

};

Line level4[] = {
    {{0, 10}, {50, 10}},      {{0, 11}, {50, 11}},      {{0, 12}, {50, 12}},      {{0, 13}, {50, 13}},
    {{0, 14}, {50, 14}},      {{0, 15}, {50, 15}},      {{0, 16}, {50, 16}},      {{0, 17}, {50, 17}},
    {{70, 10}, {319, 10}},    {{70, 11}, {319, 11}},    {{70, 12}, {319, 12}},    {{70, 13}, {319, 13}},
    {{70, 14}, {319, 14}},    {{70, 15}, {319, 15}},    {{70, 16}, {319, 16}},    {{70, 17}, {319, 17}},

    {{0, 50}, {50, 50}},      {{0, 51}, {50, 51}},      {{0, 52}, {50, 52}},      {{0, 53}, {50, 53}},
    {{0, 54}, {50, 54}},      {{0, 55}, {50, 55}},      {{0, 56}, {50, 56}},      {{0, 57}, {50, 57}},
    {{70, 50}, {250, 50}},    {{70, 51}, {250, 51}},    {{70, 52}, {250, 52}},    {{70, 53}, {250, 53}},
    {{70, 54}, {250, 54}},    {{70, 55}, {250, 55}},    {{70, 56}, {250, 56}},    {{70, 57}, {250, 57}},

    {{0, 90}, {50, 90}},      {{0, 91}, {50, 91}},      {{0, 92}, {50, 92}},      {{0, 93}, {50, 93}},
    {{0, 94}, {50, 94}},      {{0, 95}, {50, 95}},      {{0, 96}, {50, 96}},      {{0, 97}, {50, 97}},
    {{70, 90}, {187, 90}},    {{70, 91}, {187, 91}},    {{70, 92}, {187, 92}},    {{70, 93}, {187, 93}},
    {{70, 94}, {187, 94}},    {{70, 95}, {187, 95}},    {{70, 96}, {187, 96}},    {{70, 97}, {187, 97}},

    {{0, 130}, {50, 130}},    {{0, 131}, {50, 131}},    {{0, 132}, {50, 132}},    {{0, 133}, {50, 133}},
    {{0, 134}, {50, 134}},    {{0, 135}, {50, 135}},    {{0, 136}, {50, 136}},    {{0, 137}, {50, 137}},
    {{100, 130}, {180, 130}}, {{100, 131}, {180, 131}}, {{100, 132}, {180, 132}}, {{100, 133}, {180, 133}},
    {{100, 134}, {180, 134}}, {{100, 135}, {180, 135}}, {{100, 136}, {180, 136}}, {{100, 137}, {180, 137}},

    {{180, 130}, {180, 239}}, {{181, 130}, {181, 239}}, {{182, 130}, {182, 239}}, {{183, 130}, {183, 239}},
    {{184, 130}, {184, 239}}, {{185, 130}, {185, 239}}, {{186, 130}, {186, 239}}, {{187, 130}, {187, 239}},

    {{260, 100}, {260, 239}}, {{261, 100}, {261, 239}}, {{262, 100}, {262, 239}}, {{263, 100}, {263, 239}},
    {{264, 100}, {264, 239}}, {{265, 100}, {265, 239}}, {{266, 100}, {266, 239}}, {{267, 100}, {267, 239}},

    {{260, 130}, {318, 130}}, {{260, 131}, {318, 131}}, {{260, 132}, {318, 132}}, {{260, 133}, {318, 133}},
    {{260, 134}, {318, 134}}, {{260, 135}, {318, 135}}, {{260, 136}, {318, 136}}, {{260, 137}, {318, 137}},

};

Line level5[] = {
    {{0, 30}, {40, 30}},      {{0, 31}, {40, 31}},      {{0, 32}, {40, 32}},      {{0, 33}, {40, 33}},
    {{0, 34}, {40, 34}},      {{0, 35}, {40, 35}},      {{0, 36}, {40, 36}},      {{0, 37}, {40, 37}},
    {{0, 38}, {40, 38}},      {{0, 39}, {40, 39}},      {{0, 40}, {40, 40}},

    {{0, 95}, {30, 95}},      {{0, 96}, {30, 96}},      {{0, 97}, {30, 97}},      {{0, 98}, {30, 98}},
    {{0, 99}, {30, 99}},      {{0, 100}, {30, 100}},    {{0, 101}, {30, 101}},    {{0, 102}, {30, 102}},
    {{0, 103}, {30, 103}},    {{0, 104}, {30, 104}},

    {{0, 170}, {30, 170}},    {{0, 171}, {30, 171}},    {{0, 172}, {30, 172}},    {{0, 173}, {30, 173}},
    {{0, 174}, {30, 174}},    {{0, 175}, {30, 175}},    {{0, 176}, {30, 176}},    {{0, 177}, {30, 177}},
    {{0, 178}, {30, 178}},    {{0, 179}, {30, 179}},    {{0, 180}, {30, 180}},

    {{75, 11}, {75, 80}},     {{76, 11}, {76, 80}},     {{77, 11}, {77, 80}},     {{78, 11}, {78, 80}},
    {{79, 11}, {79, 80}},     {{80, 11}, {80, 80}},     {{81, 11}, {81, 80}},     {{82, 11}, {82, 80}},
    {{83, 11}, {83, 80}},     {{84, 11}, {84, 80}},

    {{75, 126}, {75, 195}},   {{76, 126}, {76, 195}},   {{77, 126}, {77, 195}},   {{78, 126}, {78, 195}},
    {{79, 126}, {79, 195}},   {{80, 126}, {80, 195}},   {{81, 126}, {81, 195}},   {{82, 126}, {82, 195}},
    {{83, 126}, {83, 195}},   {{84, 126}, {84, 195}},

    {{55, 70}, {75, 70}},     {{55, 71}, {75, 71}},     {{55, 72}, {75, 72}},     {{55, 73}, {75, 73}},
    {{55, 74}, {75, 74}},     {{55, 75}, {75, 75}},     {{55, 76}, {75, 76}},     {{55, 77}, {75, 77}},
    {{55, 78}, {75, 78}},     {{55, 79}, {75, 79}},

    {{55, 126}, {75, 126}},   {{55, 127}, {75, 127}},   {{55, 128}, {75, 128}},   {{55, 129}, {75, 129}},
    {{55, 130}, {75, 130}},   {{55, 131}, {75, 131}},   {{55, 132}, {75, 132}},   {{55, 133}, {75, 133}},
    {{55, 134}, {75, 134}},   {{55, 135}, {75, 135}},   {{55, 136}, {75, 136}},

    {{120, 11}, {120, 110}},  {{121, 11}, {121, 110}},  {{122, 11}, {122, 110}},  {{123, 11}, {123, 110}},
    {{124, 11}, {124, 110}},  {{125, 11}, {125, 110}},  {{126, 11}, {126, 110}},  {{127, 11}, {127, 110}},
    {{128, 11}, {128, 110}},  {{129, 11}, {129, 110}},  {{130, 11}, {130, 110}},  {{131, 11}, {131, 110}},
    {{132, 11}, {132, 110}},  {{133, 11}, {133, 110}},  {{134, 11}, {134, 110}},  {{135, 11}, {135, 110}},

    {{120, 180}, {120, 240}}, {{121, 180}, {121, 240}}, {{122, 180}, {122, 240}}, {{123, 180}, {123, 240}},
    {{124, 180}, {124, 240}}, {{125, 180}, {125, 240}}, {{126, 180}, {126, 240}}, {{127, 180}, {127, 240}},
    {{128, 180}, {128, 240}}, {{129, 180}, {129, 240}}, {{130, 180}, {130, 240}}, {{131, 180}, {131, 240}},
    {{132, 180}, {132, 240}}, {{133, 180}, {133, 240}}, {{134, 180}, {134, 240}}, {{135, 180}, {135, 240}},

    {{180, 100}, {180, 190}}, {{181, 100}, {181, 190}}, {{182, 100}, {182, 190}}, {{183, 100}, {183, 190}},
    {{184, 100}, {184, 190}}, {{185, 100}, {185, 190}}, {{186, 100}, {186, 190}}, {{187, 100}, {187, 190}},
    {{188, 100}, {188, 190}}, {{189, 100}, {189, 190}}, {{190, 100}, {190, 190}}, {{191, 100}, {191, 190}},
    {{192, 100}, {192, 190}}, {{193, 100}, {193, 190}}, {{194, 100}, {194, 190}}, {{195, 100}, {195, 190}},

    {{240, 180}, {240, 240}}, {{241, 180}, {241, 240}}, {{242, 180}, {242, 240}}, {{243, 180}, {243, 240}},
    {{244, 180}, {244, 240}}, {{245, 180}, {245, 240}}, {{246, 180}, {246, 240}}, {{247, 180}, {247, 240}},
    {{248, 180}, {248, 240}}, {{249, 180}, {249, 240}}, {{250, 180}, {250, 240}}, {{251, 180}, {251, 240}},
    {{252, 180}, {252, 240}}, {{253, 180}, {253, 240}}, {{254, 180}, {254, 240}}, {{255, 180}, {255, 240}},

    {{240, 11}, {240, 110}},  {{241, 11}, {241, 110}},  {{242, 11}, {242, 110}},  {{243, 11}, {243, 110}},
    {{244, 11}, {244, 110}},  {{245, 11}, {245, 110}},  {{246, 11}, {246, 110}},  {{247, 11}, {247, 110}},
    {{248, 11}, {248, 110}},  {{249, 11}, {249, 110}},  {{250, 11}, {250, 110}},  {{251, 11}, {251, 110}},
    {{252, 11}, {252, 110}},  {{253, 11}, {253, 110}},  {{254, 11}, {254, 110}},  {{255, 11}, {255, 110}},

    {{295, 95}, {320, 95}},   {{295, 96}, {320, 96}},   {{295, 97}, {320, 97}},   {{295, 98}, {320, 98}},
    {{295, 99}, {320, 99}},   {{295, 100}, {320, 100}}, {{295, 101}, {320, 101}}, {{295, 102}, {320, 102}},
    {{295, 103}, {320, 103}}, {{295, 104}, {320, 104}}, {{295, 105}, {320, 105}}, {{295, 106}, {320, 106}},
    {{295, 107}, {320, 107}}, {{295, 108}, {320, 108}}, {{295, 109}, {320, 109}}, {{295, 110}, {320, 110}},
};
...
int main(void)
{
    ...
    *(pixel_ctrl_ptr + 1) = (int)&Buffer2;
    ...
    while (1)
    {
        ...
        if (placing_line)
        {
            draw_line((int)lineArray[line_count].p1.x, (int)lineArray[line_count].p1.y, prev_cursorx, prev_cursory,
                      0x0);
        }
        ...
        if (lives == 0 || board_resetting > 0 || (b3 == 0x2D && b2 == 0xF0))
        {
            ...
            for (int i = 0; i < line_max; i++)
            {
                if (temp_line_array[i].p1.x != -1 && temp_line_array[i].p1.y != -1 && temp_line_array[i].p2.x != -1 &&
                    temp_line_array[i].p2.y != -1)
                {
                    draw_line(temp_line_array[i].p1.x, temp_line_array[i].p1.y, temp_line_array[i].p2.x,
                              temp_line_array[i].p2.y, 0x0);
                }
            }
            board_resetting++;
        ...
        for (int i = 0; i < line_max; i++)
        {
            if (lineArray[i].p1.x != -1 && lineArray[i].p1.y != -1 && lineArray[i].p2.x != -1 &&
                lineArray[i].p2.y != -1)
            {
...
void update_ball(void)
{
    ...
    if (balldrop == true)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            if (ballx >= portalx[i] - 4 && ballx <= portalx[i] + 4 && bally >= portaly[i] - 4 &&
                bally <= portaly[i] + 4)
            {
    ...
    if (line_count < line_max)
    {
        if (b3 == 0x5A)
        {
            if (b2 == 0xF0)
            {
                if (!placing_line)
                {
                    if ((int)lineArray[line_count - 1].p2.x != cursorx ||
                        (int)lineArray[line_count - 1].p2.y != cursory)
                    {
                        placing_line = true;
                ...
                else if (placing_line)
                {
                    ...
                    {
                        if (calculate_length((int)lineArray[line_count].p1.x, (int)lineArray[line_count].p1.y, cursorx,
                                             cursory) < max_line_length)
                        {
                            ...
                            max_line_length -= calculate_length((int)lineArray[line_count].p1.x,
                                                                (int)lineArray[line_count].p2.y, cursorx, cursory);
                            printf("placed line with length %d\n",
                                   calculate_length((int)lineArray[line_count].p1.x, (int)lineArray[line_count].p2.y,
                                                    cursorx, cursory));
